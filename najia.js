...
(function (root, factory) {
  ...
  //
  // 先说一件要紧的:此前这里挂着「用神章第八」当总纲出处——**那是挂不住的**。
  // 查下来这份转录的**卷之一(第一章到第二十六章)只有章名、没有正文**,用神章第八正在其中;
  // 更巧的是原书自己在疾病章里写「占父母弟兄取用神者皆在用神章內詳之」,
  // 即逐事细目本就编在那一章——而那一章我们手上是空的。所以总纲那句已删。
  //
  // 能挂的,是散在卷之三、卷之四各门类章里的逐事断语(那几卷正文俱在),逐条见下面每一行的 src。
  // 挂不上的照旧写「通行口径,出处待核」,不许硬凑。核对工具:tools/chapter-check.mjs。
  const YONG_SHEN = [
    ...
    { re: /(病|疾|症|痛|健康|手术|住院|化验|癌|灾)/, liuQin: '官鬼', note: '问病以官鬼为病症、子孙为医药,两头对看',
      src: '出处:《增删卜易》「占醫藥子孫爲用﹐子孫克世者卽愈」(此句落在卷之二末段,而那一段的章标题在本转录里丢了,故只挂书不挂章;' +
           '病症取官鬼那一半原书编在卷之一用神章,本转录无正文,仍待核)' },
    { re: /(工作|职位|事业|升职|晋升|考公|考编|上班|老板|领导|官司|诉讼|名声|竞选|比赛|录取|面试)/, liuQin: '官鬼', note: '问功名事业官非以官鬼为用神',
      src: '出处:《增删卜易》「占官差以官鬼爲用」(同上,落在卷之二末段丢了标题的那几章里,只挂书不挂章)' },
